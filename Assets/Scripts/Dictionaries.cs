...
public class Dictionaries : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (!descriptions.ContainsKey(7)) descriptions.Add(8, "Algorytm DFS (Depth-First Search) to algorytm przeszukiwania grafu lub drzewa, który eksploruje wêz³y w g³¹b, odwiedzaj¹c s¹siadów wzd³u¿ jednej œcie¿ki, zanim wróci do wêz³ów na innych œcie¿kach.");
    }
}